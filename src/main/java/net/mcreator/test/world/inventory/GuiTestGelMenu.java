...
public class GuiTestGelMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GuiTestGelMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TestModMenus.GUI_TEST_GEL.get(), id);

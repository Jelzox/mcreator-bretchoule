...
public class SlabToBlockProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == TestModBlocks.VERTICAL_SLAB.get()
				&& (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(TestModBlocks.VERTICAL_SLAB.get())) : false)) {
			if (entity instanceof LivingEntity _entity) {
				ItemStack _setstack = new ItemStack(TestModBlocks.VERTICAL_SLAB.get()).copy();

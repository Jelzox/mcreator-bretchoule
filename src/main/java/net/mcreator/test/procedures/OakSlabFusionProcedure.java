...
public class OakSlabFusionProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.isShiftKeyDown()) {
			if ((new Object() {
			...
			}.with(TestModBlocks.OAK_ALT_SLAB.get().defaultBlockState(), Direction.NORTH)).getBlock()) {
				{
				...
				if ((new Object() {
				...
				}.with(TestModBlocks.OAK_ALT_SLAB.get().defaultBlockState(), Direction.SOUTH)).getBlock()) {
					{
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockState _bs = Blocks.AIR.defaultBlockState();
						BlockState _bso = world.getBlockState(_bp);
					...
					if ((new Object() {
					...
					}.with(TestModBlocks.OAK_ALT_SLAB.get().defaultBlockState(), Direction.WEST)).getBlock()) {
						{
							BlockPos _bp = BlockPos.containing(x, y, z);
							BlockState _bs = Blocks.AIR.defaultBlockState();
							BlockState _bso = world.getBlockState(_bp);
						...
						}.with(TestModBlocks.OAK_ALT_SLAB.get().defaultBlockState(), Direction.EAST)).getBlock()) {
							{
								BlockPos _bp = BlockPos.containing(x, y, z);
								BlockState _bs = Blocks.AIR.defaultBlockState();
								BlockState _bso = world.getBlockState(_bp);
